...
* :func:`popdgp.metrics.energy_distance` -- strictly proper joint score
  (weight-sensitive block);
* :func:`popdgp.metrics.prdc` -- support/coverage geometry; coverage is
  invariant to any reweighting of the candidate (calibration-blind block) and
  is the anti-mode-collapse axis;
* :func:`popdgp.metrics.classifier_two_sample_auc` -- the omnibus
