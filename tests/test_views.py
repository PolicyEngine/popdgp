...
Ported from imputation-paper's ``tests/test_views.py`` (only the import path
changes): the harness behaviour must survive the extraction unchanged.

The setup mirrors the framework's formal picture at toy scale: one latent
